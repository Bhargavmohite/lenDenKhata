            ...
            <View className='flex-1 justify-center items-center bg-black/40'>
              <View className='bg-white w-[90%] rounded-xl p-5'>
                ...
                {invoiceList.length > 0 && (
                  <>
                    <Text className='mt-3 mb-2'>Voucher</Text>
                ...
                {selectedInvoiceId !== "" && (
                  <>
                    <Text className='mt-4 mb-2'>Voucher Number</Text>
                    ...
                    <View className='rounded-lg border border-[#dbe0e6] mb-3'>
                      <Picker
                        ...
                        onValueChange={(value) =>
                          setForm({
                            ...form,
                            supplyId: value !== null ? Number(value) : null,
                          })
                        }
                      >
                        <Picker.Item label='Select Supplier' value={null} />
                    ...
                    <View className='rounded-lg border border-[#dbe0e6] mb-3'>
                      <Picker
                        ...
                        onValueChange={(value) =>
                          setForm({
                            ...form,
                            bankId: value !== null ? Number(value) : null,
                          })
                        }
                      >
                        <Picker.Item label='Select Bank' value={null} />
...
function getBalanceBySupplierId(supplyId: number) {
